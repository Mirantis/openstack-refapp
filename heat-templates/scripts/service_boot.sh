...
function install_app {
    install_docker
    docker run --restart=always -dit -p ${APP_PORT}:${APP_PORT} -e OS_REFAPP_DB_URL="myslq+pymysql://${APP_DATABASE_USER}:${APP_DATABASE_PASSWORD}@${DATABASE_VIP}:3306/refapp" $APP_DOCKER_IMAGE
}
